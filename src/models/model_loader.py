...
from src.models.iterative_models.iterative_separated_weights_inverse_multichannel import get_iterative_separated_weights_inverse_multichannel_model
...
def load_iterative_explicit_warping_model(args, device):
    ...
    elif iterative_name == "irseparatedchannelsinverse":
        model = get_iterative_separated_weights_inverse_multichannel_model(
            device, backbone_name, False, args.max_iterations, filenames, args=args,
            trained_end2end=pretrained_end2end)
    else:
